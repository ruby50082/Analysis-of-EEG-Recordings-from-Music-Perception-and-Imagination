...
class Fully_Conv(nn.Module):
    def __init__(self):
        ...
        self.conv_classifier=nn.Sequential(
             nn.Conv2d(50,3,kernel_size=(1,6),stride=(1,1),bias=True), #50,3,1,3,1,1    #3s:(1,6) 4s:(1,8) 5s:(1,11) 6s:(1,14)
             nn.Softmax()
        )
...
class Fully_Conv0(nn.Module):
    def __init__(self):
        super(Fully_Conv0,self).__init__()
        self.spatial = nn.Sequential(
             nn.Conv2d(64,25,kernel_size=(1,1),stride = (1,1)),
        )
        self.conv2d=nn.Sequential(
        ...
        self.conv_classifier=nn.Sequential(
             nn.Conv2d(50,4,kernel_size=(1,6),stride=(1,1),bias=True), #50,3,1,3,1,1    #3s:(1,6) 4s:(1,8) 5s:(1,11) 6s:(1,14)
             nn.Softmax()
        )
        self.lstm = nn.Sequential(
            nn.Dropout(p=0.5),
...
class Fully_Conv1(nn.Module):
    def __init__(self):
        super(Fully_Conv1,self).__init__()
        self.spatial = nn.Sequential(
             nn.Conv2d(64,25,kernel_size=(1,1),stride = (1,1)),
        )
        self.conv2d=nn.Sequential(
...
class Fully_Conv2(nn.Module):
    def __init__(self):
        super(Fully_Conv2,self).__init__()
        self.spatial = nn.Sequential(
             nn.Conv2d(64,25,kernel_size=(1,1),stride = (1,1)),
        )
        self.conv2d=nn.Sequential(
